...
// in test_futter_project/test/data/repositories/geolocator_repository_impl_test.dart.
...
class MockAppGeolocatorService extends _i1.Mock
    implements _i2.AppGeolocatorService {
