...
void main() {
  group('OwnerModel', () {
    test('constructor assigns values correctly', () {
      final owner = OwnerEntity(id: '1', name: 'Alice', linkedItemIds: ['a', 'b']);
      expect(owner.id, '1');
    ...
    test('equality and hashCode: identical objects', () {
      final o1 = OwnerEntity(id: '1', name: 'Alice', linkedItemIds: ['a', 'b']);
      final o2 = OwnerEntity(id: '1', name: 'Alice', linkedItemIds: ['a', 'b']);
      expect(o1, o2);
    ...
    test('equality and hashCode: different objects', () {
      final o1 = OwnerEntity(id: '1', name: 'Alice', linkedItemIds: ['a', 'b']);
      final o2 = OwnerEntity(id: '2', name: 'Alice', linkedItemIds: ['a', 'b']);
      final o3 = OwnerEntity(id: '1', name: 'Bob', linkedItemIds: ['a', 'b']);
      final o4 = OwnerEntity(id: '1', name: 'Alice', linkedItemIds: ['b', 'a']);
