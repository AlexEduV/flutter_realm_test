...
// in test_flutter_project/test/data/data_sources/local/env_local_data_source_impl_test.dart.
...
class MockDotEnv extends _i1.Mock implements _i2.DotEnv {
  ...
  Map<String, String> get env =>
      (super.noSuchMethod(Invocation.getter(#env), returnValue: <String, String>{})
  ...
  int getInt(String? name, {int? fallback}) =>
      (super.noSuchMethod(Invocation.method(#getInt, [name], {#fallback: fallback}), returnValue: 0)
          as int);
  ...
  String? maybeGet(String? name, {String? fallback}) =>
      (super.noSuchMethod(Invocation.method(#maybeGet, [name], {#fallback: fallback})) as String?);
  ...
  bool isEveryDefined(Iterable<String>? vars) =>
      (super.noSuchMethod(Invocation.method(#isEveryDefined, [vars]), returnValue: false) as bool);
}
