...
// in test_flutter_project/test/data/data_sources/remote/car_remote_data_source_impl_test.dart.
...
class MockGetOwnerByIdUseCase extends _i1.Mock implements _i3.GetOwnerByIdUseCase {
  ...
  _i2.OwnerEntity call(String? params) =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _FakeOwnerEntity_0(this, Invocation.method(#call, [params])),
          )
          as _i2.OwnerEntity);
}
