...
// in test_flutter_project/test/presentation/features/explore/explore_page_cubit_test.dart.
...
class MockWatchCarsUseCase extends _i1.Mock implements _i4.WatchCarsUseCase {
  @override
  _i3.Stream<List<_i5.CarEntity>> call() => (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
        ),
        returnValue: _i3.Stream<List<_i5.CarEntity>>.empty(),
        returnValueForMissingStub: _i3.Stream<List<_i5.CarEntity>>.empty(),
      ) as _i3.Stream<List<_i5.CarEntity>>);
}
...
class MockFetchArticlesUseCase extends _i1.Mock
  ...
  @override
  _i3.Future<List<_i7.ArticleEntity>> call() => (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
        ),
        returnValue:
            _i3.Future<List<_i7.ArticleEntity>>.value(<_i7.ArticleEntity>[]),
...
class MockGetCarByIdUseCase extends _i1.Mock implements _i8.GetCarByIdUseCase {
  @override
  _i5.CarEntity? call(String? params) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
        ),
