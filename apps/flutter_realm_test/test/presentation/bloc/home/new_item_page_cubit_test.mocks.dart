...
import 'package:test_flutter_project/domain/entities/car_auto_complete_entity.dart' as _i6;
...
import 'package:test_flutter_project/domain/usecases/auto_complete/get_auto_complete_manufacturers_by_type_use_case.dart'
    as _i4;
import 'package:test_flutter_project/domain/usecases/database/add_car_use_case.dart' as _i8;
import 'package:test_flutter_project/domain/usecases/database/get_all_cars_use_case.dart' as _i10;
...
import 'package:test_flutter_project/presentation/bloc/user/user_data_state.dart' as _i3;
...
class MockGetAutoCompleteManufacturersByTypeUseCase extends _i1.Mock
  ...
  _i5.Future<List<_i6.CarAutoCompleteEntity>> call(_i7.CarType? params) =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i5.Future<List<_i6.CarAutoCompleteEntity>>.value(
              <_i6.CarAutoCompleteEntity>[],
            ),
          )
...
class MockAddCarUseCase extends _i1.Mock implements _i8.AddCarUseCase {
  @override
  void call(_i9.CarEntity? params) =>
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetCurrentMaxCarIdUseCase extends _i1.Mock implements _i11.GetCurrentMaxCarIdUseCase {
  @override
  int call() =>
      (super.noSuchMethod(
            Invocation.method(#call, []),
...
class MockUserDataCubit extends _i1.Mock implements _i12.UserDataCubit {
  ...
  _i2.UserEntity get user =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _FakeUserEntity_0(this, Invocation.getter(#user)),
          )
          as _i2.UserEntity);

  @override
  set user(_i2.UserEntity? _user) =>
  ...
  _i3.UserDataState get state =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _FakeUserDataState_1(this, Invocation.getter(#state)),
          )
  ...
  @override
  void updateUser({required _i2.UserEntity? user, bool? updateCloud = true}) => super.noSuchMethod(
    Invocation.method(#updateUser, [], {#user: user, #updateCloud: updateCloud}),
    returnValueForMissingStub: null,
  );

  @override
  void emit(_i3.UserDataState? state) =>
      super.noSuchMethod(Invocation.method(#emit, [state]), returnValueForMissingStub: null);

  @override
  void onChange(_i13.Change<_i3.UserDataState>? change) =>
