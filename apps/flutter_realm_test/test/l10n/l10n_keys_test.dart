...
void main() {
  group('L10nKeys', () {
    ...
    test(
      'explorePageTitle',
      () => expect(L10nKeys.explorePageTitle, 'pages.explore.title'),
    );
    test(
      'results',
      () => expect(L10nKeys.results, 'pages.search.resultsSection.title'),
    );
    test(
      'favoritesPageTitle',
      () => expect(L10nKeys.favoritesPageTitle, 'pages.favorites.title'),
    );
    test(
    ...
    test(
      'deleteButtonTitle',
      () => expect(L10nKeys.deleteButtonTitle, 'actions.delete.title'),
    );
    test(
      'distanceWidgetText',
      () => expect(L10nKeys.distanceAway, 'widgets.distance.text'),
    );
    test(
      'recommendedSectionTitle',
      () => expect(
        L10nKeys.recommendedSectionTitle,
    ...
    test(
      ...
      () => expect(
        L10nKeys.lastSeenSectionTitle,
        'pages.explore.lastSeenSection.title',
      ),
    );
    test(
      'searchPageTitle',
      () => expect(L10nKeys.searchPageTitle, 'pages.search.title'),
    );
    test(
      'searchTabCars',
      () => expect(L10nKeys.searchTabCars, 'pages.search.tabs.cars'),
    );
    test(
      'searchTabBikes',
      () => expect(L10nKeys.searchTabBikes, 'pages.search.tabs.bikes'),
    );
    test(
      'searchTabTrucks',
      () => expect(L10nKeys.searchTabTrucks, 'pages.search.tabs.trucks'),
    );
    test(
    ...
    test(
      'parameterYearName',
      () => expect(L10nKeys.parameterYearName, 'filters.parameters.year'),
    );
    test(
      'parameterColorName',
    ...
    test(
      ...
      () => expect(
        L10nKeys.parameterBodyTypeName,
    ...
    test(
      ...
      () => expect(
        L10nKeys.parameterPriceRangeName,
        'filters.parameters.priceRange',
      ),
    );
    test(
      'parameterFuelTypeName',
      () => expect(
        L10nKeys.parameterFuelTypeName,
    ...
    test(
      'bodyTypeMinivan',
      () => expect(
        L10nKeys.bodyTypeMinivan,
        'filters.parameters.bodyTypes.minivan',
      ),
    );
    test(
      'bodyTypeCoupe',
    ...
    test(
      'bodyTypeCrossover',
      () => expect(
        L10nKeys.bodyTypeCrossover,
        'filters.parameters.bodyTypes.crossover',
      ),
    );
    test(
      'bodyTypeSemi',
      () => expect(L10nKeys.bodyTypeSemi, 'filters.parameters.bodyTypes.semi'),
    );
    test(
      'bodyTypeBike',
      () => expect(L10nKeys.bodyTypeBike, 'filters.parameters.bodyTypes.bike'),
    );
    test(
      'fuelTypeDiesel',
      () => expect(
        L10nKeys.fuelTypeDiesel,
        'filters.parameters.fuelTypes.diesel',
      ),
    );
    test(
      'fuelTypeGasoline',
      () => expect(
        L10nKeys.fuelTypeGasoline,
        'filters.parameters.fuelTypes.gasoline',
      ),
    );
    test(
      'fuelTypeEv',
      () => expect(L10nKeys.fuelTypeEv, 'filters.parameters.fuelTypes.ev'),
    );
    test(
      'fuelTypeHybrid',
      () => expect(
        L10nKeys.fuelTypeHybrid,
        'filters.parameters.fuelTypes.hybrid',
      ),
    );
    test(
    ...
    test(
      ...
      () => expect(
        L10nKeys.transmissionTypeHybrid,
    ...
    test(
      ...
      () => expect(
        L10nKeys.vehicleSpecificationsSectionTitle,
    ...
    test(
      ...
      () => expect(
        L10nKeys.vehicleSpecificationBody,
    ...
    test(
      ...
      () => expect(
        L10nKeys.vehicleSpecificationEngine,
    ...
    test(
      ...
      () => expect(
        L10nKeys.vehicleSpecificationColor,
    ...
    test(
      ...
      () => expect(
        L10nKeys.vehicleSpecificationYear,
    ...
    test(
      ...
      () => expect(
        L10nKeys.forgotPasswordButtonTitle,
        'forms.ui.forgotPasswordButtonText',
      ),
    );
    test(
      'loginButtonTitle',
      () => expect(L10nKeys.loginButtonTitle, 'forms.ui.loginButtonTitle'),
    );
    test(
      'signUpButtonTitle',
    ...
    test(
      'orDividerTitle',
      () => expect(L10nKeys.orDividerTitle, 'forms.ui.orDividerTitle'),
    );
    test(
    ...
    test(
      ...
      () => expect(
        L10nKeys.authPasswordStrengthLengthHint,
    ...
    test(
      ...
      () => expect(
        L10nKeys.inboxPageLoggedOutText,
    ...
    test(
      'inboxPageEmptyText',
      () => expect(
        L10nKeys.inboxPageEmptyText,
        'pages.inbox.emptyPlaceholderText',
      ),
    );
    test(
      'inboxPageTitle',
      () => expect(L10nKeys.inboxPageTitle, 'pages.inbox.title'),
    );
    test(
      'accountPageTitle',
      () => expect(L10nKeys.accountPageTitle, 'pages.account.title'),
    );
    test(
    ...
    test(
      ...
      () => expect(
        L10nKeys.locationSettingsItemRegion,
    ...
    test(
      'accountItemMyItems',
      () => expect(
        L10nKeys.accountItemMyItems,
        'pages.account.items.myItems.title',
      ),
    );
    test(
    ...
    test(
      ...
      () => expect(
        L10nKeys.accountItemViewedItems,
