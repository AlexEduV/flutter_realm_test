class L10nKeys {
  ...
  static const String accountItemViewedItems = 'pages.account.items.recentlyViewed.title';
  static const String viewedItemsNoResultsPlaceholder =
      'pages.account.items.recentlyViewed.emptyPlaceholder';

  static const String accountItemClearData = 'pages.account.items.clearData.title';
  static const String dataDeletionDescription =
      'pages.account.items.clearData.dataDeletionDescription';
  static const String clearViewHistoryItem = 'pages.account.items.clearData.viewedHistoryItem';
  static const String clearFavoritesItem = 'pages.account.items.clearData.favoritesItem';
  static const String clearMyItemsItem = 'pages.account.items.clearData.myItemsItem';
  static const String clearAllDataItem = 'pages.account.items.clearData.clearAllDataItem';
