...
mixin _$InboxPageState {
  ...
  $InboxPageStateCopyWith<InboxPageState> get copyWith =>
      _$InboxPageStateCopyWithImpl<InboxPageState>(
          this as InboxPageState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InboxPageState &&
...
abstract mixin class $InboxPageStateCopyWith<$Res> {
  factory $InboxPageStateCopyWith(
...
class _InboxPageState implements InboxPageState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$InboxPageStateCopyWith<_InboxPageState> get copyWith =>
      __$InboxPageStateCopyWithImpl<_InboxPageState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _InboxPageState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$InboxPageStateCopyWith<$Res>
    implements $InboxPageStateCopyWith<$Res> {
  factory _$InboxPageStateCopyWith(
          _InboxPageState value, $Res Function(_InboxPageState) _then) =
