...
mixin _$MessagesPageState {
 ...
 bool get isLoading; String? get currentConversationId; String get currentMessageText; String get currentGifSearchText; bool get areGifsLoading; String get latestQuery; List<GifEntity> get gifsInSearch; String? get selectedGif;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MessagesPageState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.currentConversationId, currentConversationId) || other.currentConversationId == currentConversationId)&&(identical(other.currentMessageText, currentMessageText) || other.currentMessageText == currentMessageText)&&(identical(other.currentGifSearchText, currentGifSearchText) || other.currentGifSearchText == currentGifSearchText)&&(identical(other.areGifsLoading, areGifsLoading) || other.areGifsLoading == areGifsLoading)&&(identical(other.latestQuery, latestQuery) || other.latestQuery == latestQuery)&&const DeepCollectionEquality().equals(other.gifsInSearch, gifsInSearch)&&(identical(other.selectedGif, selectedGif) || other.selectedGif == selectedGif));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,currentConversationId,currentMessageText,currentGifSearchText,areGifsLoading,latestQuery,const DeepCollectionEquality().hash(gifsInSearch),selectedGif);

@override
String toString() {
  return 'MessagesPageState(isLoading: $isLoading, currentConversationId: $currentConversationId, currentMessageText: $currentMessageText, currentGifSearchText: $currentGifSearchText, areGifsLoading: $areGifsLoading, latestQuery: $latestQuery, gifsInSearch: $gifsInSearch, selectedGif: $selectedGif)';
}
...
@useResult
$Res call({
 bool isLoading, String? currentConversationId, String currentMessageText, String currentGifSearchText, bool areGifsLoading, String latestQuery, List<GifEntity> gifsInSearch, String? selectedGif
});
...
/// Create a copy of MessagesPageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? currentConversationId = freezed,Object? currentMessageText = null,Object? currentGifSearchText = null,Object? areGifsLoading = null,Object? latestQuery = null,Object? gifsInSearch = null,Object? selectedGif = freezed,}) {
...
class _MessagesPageState implements MessagesPageState {
  const _MessagesPageState({this.isLoading = false, this.currentConversationId, this.currentMessageText = '', this.currentGifSearchText = '', this.areGifsLoading = false, this.latestQuery = '', final  List<GifEntity> gifsInSearch = const [], this.selectedGif}): _gifsInSearch = gifsInSearch;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,currentConversationId,currentMessageText,currentGifSearchText,areGifsLoading,latestQuery,const DeepCollectionEquality().hash(_gifsInSearch),selectedGif);
...
/// Create a copy of MessagesPageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? currentConversationId = freezed,Object? currentMessageText = null,Object? currentGifSearchText = null,Object? areGifsLoading = null,Object? latestQuery = null,Object? gifsInSearch = null,Object? selectedGif = freezed,}) {
