...
mixin _$ExplorePageState {
 ...
 List<CarEntity> get cars; bool get isLoading; CarEntity? get lastSeenCar;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExplorePageState&&const DeepCollectionEquality().equals(other.cars, cars)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.lastSeenCar, lastSeenCar) || other.lastSeenCar == lastSeenCar));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(cars),isLoading,lastSeenCar);

@override
String toString() {
  return 'ExplorePageState(cars: $cars, isLoading: $isLoading, lastSeenCar: $lastSeenCar)';
}
...
@useResult
$Res call({
 List<CarEntity> cars, bool isLoading, CarEntity? lastSeenCar
});
...
/// Create a copy of ExplorePageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cars = null,Object? isLoading = null,Object? lastSeenCar = freezed,}) {
...
class _ExplorePageState implements ExplorePageState {
  const _ExplorePageState({final  List<CarEntity> cars = const [], this.isLoading = false, this.lastSeenCar = null}): _cars = cars;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExplorePageState&&const DeepCollectionEquality().equals(other._cars, _cars)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.lastSeenCar, lastSeenCar) || other.lastSeenCar == lastSeenCar));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_cars),isLoading,lastSeenCar);
...
/// Create a copy of ExplorePageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cars = null,Object? isLoading = null,Object? lastSeenCar = freezed,}) {
