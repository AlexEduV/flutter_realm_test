...
part of 'new_item_page_state.dart';
...
mixin _$NewItemPageState {
 ...
 FieldParamsModel? get manufacturerFieldParams; FieldParamsModel? get modelFieldParams; FieldParamsModel? get yearFieldParams; FieldParamsModel? get colorFieldParams; String? get manufacturerErrorText; String? get modelErrorText; String? get yearErrorText; String? get colorErrorText; String get manufacturerText; String get modelText; String get yearText; String get colorText; int get currentPageIndex; CarType get selectedCarType;
...
@override
int get hashCode => Object.hash(runtimeType,manufacturerFieldParams,modelFieldParams,yearFieldParams,colorFieldParams,manufacturerErrorText,modelErrorText,yearErrorText,colorErrorText,manufacturerText,modelText,yearText,colorText,currentPageIndex,selectedCarType);

@override
String toString() {
  return 'NewItemPageState(manufacturerFieldParams: $manufacturerFieldParams, modelFieldParams: $modelFieldParams, yearFieldParams: $yearFieldParams, colorFieldParams: $colorFieldParams, manufacturerErrorText: $manufacturerErrorText, modelErrorText: $modelErrorText, yearErrorText: $yearErrorText, colorErrorText: $colorErrorText, manufacturerText: $manufacturerText, modelText: $modelText, yearText: $yearText, colorText: $colorText, currentPageIndex: $currentPageIndex, selectedCarType: $selectedCarType)';
}
...
@useResult
$Res call({
 FieldParamsModel? manufacturerFieldParams, FieldParamsModel? modelFieldParams, FieldParamsModel? yearFieldParams, FieldParamsModel? colorFieldParams, String? manufacturerErrorText, String? modelErrorText, String? yearErrorText, String? colorErrorText, String manufacturerText, String modelText, String yearText, String colorText, int currentPageIndex, CarType selectedCarType
});
...
class _$NewItemPageStateCopyWithImpl<$Res>
  ...
  _$NewItemPageStateCopyWithImpl(this._self, this._then);
...
/// Create a copy of NewItemPageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? manufacturerFieldParams = freezed,Object? modelFieldParams = freezed,Object? yearFieldParams = freezed,Object? colorFieldParams = freezed,Object? manufacturerErrorText = freezed,Object? modelErrorText = freezed,Object? yearErrorText = freezed,Object? colorErrorText = freezed,Object? manufacturerText = null,Object? modelText = null,Object? yearText = null,Object? colorText = null,Object? currentPageIndex = null,Object? selectedCarType = null,}) {
...
class _NewItemPageState implements NewItemPageState {
  const _NewItemPageState({this.manufacturerFieldParams, this.modelFieldParams, this.yearFieldParams, this.colorFieldParams, this.manufacturerErrorText, this.modelErrorText, this.yearErrorText, this.colorErrorText, this.manufacturerText = '', this.modelText = '', this.yearText = '', this.colorText = '', this.currentPageIndex = AppConstants.itemSetupTabType, this.selectedCarType = CarType.car});
...
class __$NewItemPageStateCopyWithImpl<$Res>
  ...
  __$NewItemPageStateCopyWithImpl(this._self, this._then);
