...
@override
int get hashCode => Object.hash(runtimeType,manufacturerFieldParams,modelFieldParams,yearFieldParams,colorFieldParams,manufacturerErrorText,modelErrorText,yearErrorText,colorErrorText,currentPageIndex,selectedCarType);

@override
String toString() {
  return 'NewItemPageState(manufacturerFieldParams: $manufacturerFieldParams, modelFieldParams: $modelFieldParams, yearFieldParams: $yearFieldParams, colorFieldParams: $colorFieldParams, manufacturerErrorText: $manufacturerErrorText, modelErrorText: $modelErrorText, yearErrorText: $yearErrorText, colorErrorText: $colorErrorText, currentPageIndex: $currentPageIndex, selectedCarType: $selectedCarType)';
}
...
@useResult
$Res call({
 FieldParamsModel? manufacturerFieldParams, FieldParamsModel? modelFieldParams, FieldParamsModel? yearFieldParams, FieldParamsModel? colorFieldParams, String? manufacturerErrorText, String? modelErrorText, String? yearErrorText, String? colorErrorText, int currentPageIndex, CarType selectedCarType
});
...
class _NewItemPageState implements NewItemPageState {
  const _NewItemPageState({this.manufacturerFieldParams, this.modelFieldParams, this.yearFieldParams, this.colorFieldParams, this.manufacturerErrorText, this.modelErrorText, this.yearErrorText, this.colorErrorText, this.currentPageIndex = AppConstants.itemSetupTabType, this.selectedCarType = CarType.car});
