...
mixin _$SearchPageState {
 ...
 List<CarEntity> get results; CarType get currentSelectedType; bool get isLoading; List<String> get selectedModels; SearchDrawerType get drawerOpened;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchPageState&&const DeepCollectionEquality().equals(other.results, results)&&(identical(other.currentSelectedType, currentSelectedType) || other.currentSelectedType == currentSelectedType)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&const DeepCollectionEquality().equals(other.selectedModels, selectedModels)&&(identical(other.drawerOpened, drawerOpened) || other.drawerOpened == drawerOpened));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(results),currentSelectedType,isLoading,const DeepCollectionEquality().hash(selectedModels),drawerOpened);

@override
String toString() {
  return 'SearchPageState(results: $results, currentSelectedType: $currentSelectedType, isLoading: $isLoading, selectedModels: $selectedModels, drawerOpened: $drawerOpened)';
}
...
@useResult
$Res call({
 List<CarEntity> results, CarType currentSelectedType, bool isLoading, List<String> selectedModels, SearchDrawerType drawerOpened
});
...
/// Create a copy of SearchPageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? results = null,Object? currentSelectedType = null,Object? isLoading = null,Object? selectedModels = null,Object? drawerOpened = null,}) {
...
as bool,selectedModels: null == selectedModels ? _self.selectedModels : selectedModels // ignore: cast_nullable_to_non_nullable
...
class _SearchPageState implements SearchPageState {
  const _SearchPageState({final  List<CarEntity> results = const [], this.currentSelectedType = CarType.car, this.isLoading = false, final  List<String> selectedModels = const [], this.drawerOpened = SearchDrawerType.empty}): _results = results,_selectedModels = selectedModels;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SearchPageState&&const DeepCollectionEquality().equals(other._results, _results)&&(identical(other.currentSelectedType, currentSelectedType) || other.currentSelectedType == currentSelectedType)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&const DeepCollectionEquality().equals(other._selectedModels, _selectedModels)&&(identical(other.drawerOpened, drawerOpened) || other.drawerOpened == drawerOpened));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_results),currentSelectedType,isLoading,const DeepCollectionEquality().hash(_selectedModels),drawerOpened);
...
/// Create a copy of SearchPageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? results = null,Object? currentSelectedType = null,Object? isLoading = null,Object? selectedModels = null,Object? drawerOpened = null,}) {
  return _then(_SearchPageState(
results: null == results ? _self._results : results // ignore: cast_nullable_to_non_nullable
as List<CarEntity>,currentSelectedType: null == currentSelectedType ? _self.currentSelectedType : currentSelectedType // ignore: cast_nullable_to_non_nullable
as CarType,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,selectedModels: null == selectedModels ? _self._selectedModels : selectedModels // ignore: cast_nullable_to_non_nullable
as List<String>,drawerOpened: null == drawerOpened ? _self.drawerOpened : drawerOpened // ignore: cast_nullable_to_non_nullable
as SearchDrawerType,
  ));
}
